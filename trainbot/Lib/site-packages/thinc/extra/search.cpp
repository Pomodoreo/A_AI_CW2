...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "include_dirs": [
            "C:\\Users\\runneradmin\\AppData\\Local\\Temp\\build-env-ywcf0kyi\\lib\\site-packages\\numpy\\_core\\include",
...
__Pyx_RefNannySetupContext("PyInit_search", 0);
  ...
  /*--- Execution code ---*/
  __Pyx_TraceStartFunc("PyInit_search", __pyx_f[0], 1, 1, 0, 0, __PYX_ERR(0, 1, __pyx_L1_error));
